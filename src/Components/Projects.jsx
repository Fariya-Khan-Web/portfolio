...
const Projects = () => {
    ...
    return (
        <div id='project' className='max-w-screen-xl w-[94%] mx-auto pt-32 text-[#3a586d]'>
            <h1 className='text-center text-4xl md:text-5xl'>My Projects</h1>
            ...
            <div className='grid md:grid-cols-2 gap-6'>
                {projects?.map(project => (
                    <div key={project.id} data-aos={project.id%2===0? "flip-right":  "flip-left"} className='rounded-lg border bg-light border-white p-4 py-5 grid md:grid-cols-2 gap-3'>
